...
其余详细介绍请见：https://github.com/molin0000/secretMaster/blob/master/README.md`
	...
	if strings.Contains(msg, "商店") {
		return `欢迎光临星火之潮贝克兰德分店，请在浏览商品时，戴好您的斗篷和面具（找到想要购买的商品后，只需要回复购买加商品序号即可，如：购买1）
1. 探险卷轴（100金镑）：走内部渠道，可立即开始1次探险。
2. 灵性药剂（70金榜）：可增加50点灵性，每天限购1次。
3. 权杖（1000金镑）：这是成立非凡者组织或教会必不可少的证明物。
4. 灵性材料（50金榜）：随机得到1份灵性材料，可用于发动非凡仪式。
		`
	}
