...
var menus = Menu{
	...
	[]Menu{
		{1, "资料", "回复 资料 可显示与人物信息相关的指令。", "", []Menu{
			{2, "属性", "回复 属性 可查询当前人物的属性信息。", "", nil},
			{2, "尊名", "序列3以后可以自定义尊名显示，方法为@Yami尊名xxxxoooo。", "", nil},
			{2, "道具", "回复 道具 可查看当前人物持有的道具。", "", nil},
			{2, "技能", "回复 技能 可查看当前人物所有的技能。", "", nil},
			{2, "排行", "回复 排行 可查询当前群内的非凡者排行榜。", "", nil},
			{2, "查询", "回复 查询+排名 可查询排行榜上人物的属性信息。", "", nil},
		}},
		{1, "序列", "回复 序列 可显示与途径、序列相关的指令。", "", []Menu{
			{2, "途径", "回复 途径 可查询途径列表。", "", nil},
			{2, "更换", "回复 更换+途径序号 可更改当前人物的非凡途径。", "", nil},
		}},
		{1, "教会", "回复 教会 可显示与教会相关的指令。", "", []Menu{
			{2, "寻访", "回复 寻访 可查询当前已经创建的全部教会和隐秘组织。", "", nil},
			{2, "创建", "回复 创建+名称 并拥有至高权杖可创建教会或隐秘组织。", "", nil},
			{2, "解散", "回复 解散+名称 可解散自己创建的教会或隐秘组织。", "", nil},
			{2, "加入", "回复 加入+名称 可加入现有的教会或隐秘组织。", "", nil},
			{2, "退出", "回复 退出+名称 可退出当前已经加入的组织。", "", nil},
			{2, "祈祷", "回复 祈祷 可消耗1份灵性材料，得到3天的神灵庇护。", "", nil},
		}},
		{1, "商店", "回复 商店 可查看神秘黑市的商品清单。", "欢迎光临星火之潮贝克兰德分店，请在浏览商品时，戴好您的斗篷和面具（找到想要购买的商品后，只需要回复购买加商品名称即可，如：购买探险卷轴）", []Menu{
			{2, "探险卷轴（100金镑）", "走内部渠道，可立即开始1次探险。", "", nil},
			{2, "灵性药剂（70金榜）", "回复 途径 可查询途径列表。", "", nil},
			{2, "权杖（1000金镑）", "这是成立非凡者组织或教会必不可少的证明物。", "", nil},
			{2, "灵性材料（50金榜）", "随机得到1份灵性材料，可用于发动非凡仪式。", "", nil},
			{2, "红剧场门票（200金镑100灵性）", "听说很多非凡者看完表演都升级了。", "", nil},
		}},
		{1, "探险", "回复 探险 可主动触发每日3次的奇遇探险经历。", "", nil},
	},
}
