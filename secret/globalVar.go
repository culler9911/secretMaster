...
var menus = Menu{
	...
	[]Menu{
		...
		{6, "娱乐", "回复 娱乐 可查看娱乐菜单。", "", []Menu{
			{61, "银行", "可将金镑存入获得利息收益。", "", nil},
			{62, "工作", "可选择一份工作获得稳定收益。", "", nil},
			{63, "钓鱼", "可在风暴之海进行垂钓。", "", nil},
			{64, "彩票", "极小概率中奖。", "", nil},
		}},
		{7, "设置", "回复 设置 可查看插件高级设置。", "", []Menu{
			{71, ".master", "管理员设置，设置本群的GM，格式为：.master;QQ号码，必须先设置管理员，才能使用其它设置指令。", "", nil},
			...
			{78, "GM", "GM指令格式为：GM;exp;100;QQ号 目前支持exp,money,magic数值支持加和减。", "", nil},
		}},
	},
}
