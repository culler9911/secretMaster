...
var menus = Menu{
	...
	[]Menu{
		...
		{6, "娱乐", "回复 娱乐 可查看娱乐菜单。", "", []Menu{
			{61, "银行", "在本群开启序列战争插件。", "", nil},
			{62, "工作", "在本群关闭序列战争插件。", "", nil},
			{63, "钓鱼", "映射序列战争货币到其它插件ini文件，格式为：货币映射;ini路径;cQQ;关键字。", "", nil},
			{64, "彩票", "查看货币映射参数。", "", nil},
		}},
		{7, "设置", "回复 设置 可查看插件高级设置。", "", []Menu{
			{71, "序列战争开", "在本群开启序列战争插件。", "", nil},
			{72, "序列战争关", "在本群关闭序列战争插件。", "", nil},
			{73, "货币映射", "映射序列战争货币到其它插件ini文件，格式为：货币映射;ini路径;cQQ;关键字。", "", nil},
			{74, "查看映射", "查看货币映射参数。", "", nil},
			{75, "货币升级", "货币映射后，使用此命令使映射生效。", "", nil},
			{76, "货币降级", "取消货币映射，还原为插件内部金镑使用。", "", nil},
			{77, "GM指令", "格式为：GM;exp;100;QQ号 目前支持exp,money,magic数值支持加和减。", "", nil},
			{78, ".master;QQ号码", "设置本群的GM，必须先设置master，才能使用其它设置指令。", "", nil},
		}},
	},
}
