...
var menus = Menu{
	...
	[]Menu{
		...
		{6, "设置", "回复 设置 可查看插件高级设置。", "", []Menu{
			{61, "序列战争开", "在本群开启序列战争插件。", "", nil},
			{62, "序列战争关", "在本群关闭序列战争插件。", "", nil},
			{63, "货币映射", "映射序列战争货币到其它插件ini文件，格式为：货币映射;ini路径;cQQ;关键字。", "", nil},
			{64, "查看映射", "查看货币映射参数。", "", nil},
			{65, "货币升级", "货币映射后，使用此命令使映射生效。", "", nil},
			{66, "货币降级", "取消货币映射，还原为插件内部金镑使用。", "", nil},
			{67, "GM", "格式为：GM;exp;100;QQ号 目前支持exp,money,magic数值支持加和减。", "", nil},
		}},
	},
}
